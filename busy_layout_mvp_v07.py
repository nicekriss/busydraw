...
def apply_drawing_render_settings(scene, props):
    ...
    if getattr(props, "force_white_background", False):
        ...
        scene.render.film_transparent = bool(props.transparent_background)
    scene.render.image_settings.file_format = "PNG"
    scene.render.image_settings.color_mode = "RGBA" if props.transparent_background else "RGB"
...
<main class="sheet">
    <header class="title-block">
        <div>
            <h1>{title}</h1>
            <div class="subtitle">Generated by Blender Busy Layout MVP v0.7</div>
        </div>
